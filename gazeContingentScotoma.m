function gazeContingentScotoma(participantID, videoOrder)
...
% overlay)
drawFunctionHandle = @videoScotomaDrawFunction;
...
try
    ...
    if strfind(pwd,'MacScribe')
         videoNames = {'/Users/MacScribe/Dropbox/Artificial scotoma/JULIE_14a_c.mov'};
    elseif strfind(pwd,'woodslab')
       videoNames = {'/Users/woodslab/Dropbox/Artificial scotoma/JULIE_14a_c.mov'};
    else
        videoNames = {'/Users/danielsaunders/Free norm - video clips/JULIE_14a.mov'};
    end
