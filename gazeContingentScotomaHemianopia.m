function gazeContingentScotomaHemianopia(participantID, type)
...
% overlay)
drawFunctionHandle = @videoScotomaDrawFunction3;
...
% use spiral targets?
res=input('Left hemianopia condition (y/n) >','s');
if strcmp(res,'y')
   hemileft=true;
else
   hemileft=false;
...
try
    ...
    if strfind(pwd,'MacScribe')
         videoNames = {'/Users/MacScribe/Dropbox/Artificial scotoma/PAYIT_3a_c 2.mov'};
    elseif strfind(pwd,'woodslab')
       videoNames = {'/Users/woodslab/Dropbox/Artificial scotoma/PAYIT_3a_c 2.mov'};
    else
        videoNames = {'/Users/woodslab/Dropbox/Artificial scotoma/PAYIT_3a_c 2.mov'};
    end
    ...
    switch type
        case 1
         videoNames = {'/Users/MacScribe/Dropbox/Artificial scotoma/PAYIT_3a_c 2.mov'};
        case 3
             videoNames = {'/Users/MacScribe/Dropbox/Demos/video131.avi'};             
        case 2
             videoNames = {'/Users/MacScribe/Dropbox/Demos/JULIE_10a_r.mov'};
        case 4
             videoNames = {'/Users/MacScribe/Dropbox/Demos/BipolarGuide.avi'};
    end
    ...
    for i = 1:length(videoOrder)
        ...
        drawFunctionData.hemileft = hemileft;
